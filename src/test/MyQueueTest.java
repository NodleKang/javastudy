...
import test.util.MyBlockingQueue;
...
public class MyQueueTest {
        ...
        public static void main(String[] args) {
            ...
            String line;
            Map<String, MyBlockingQueue> myQueueMap = new ConcurrentHashMap<>();
            ...
            while ((line = sc.nextLine()) != null) {
                ...
                if (line.startsWith("CREATE ")) {
                    ...
                    // 큐 이름이 중복되는지 확인합니다.
                    MyBlockingQueue queue = myQueueMap.get(cmsgs[1]);
                    // 큐가 이미 존재하면 큐가 이미 존재한다는 메시지를 출력합니다.
                    if (queue != null) {
                        System.out.println("Queue Exist");
                    // 큐가 존재하지 않으면 큐를 생성합니다.
                    } else {
                        myQueueMap.put(cmsgs[1], new MyBlockingQueue(Integer.valueOf(cmsgs[2])));
                    }
                ...
                // 큐에 메시지를 전송합니다.
                    ...
                    // 큐 이름이 존재하는지 확인합니다.
                    MyBlockingQueue queue = myQueueMap.get(smsgs[1]);
